...
const travels = [
  ...
  },
  {
    ...
    year: 2026,
    days: 20,
    coverGradient: "linear-gradient(135deg, #0a001a 0%, #1a003d 50%, #2d006b 100%)",
    excerpt: "Returning to San Diego — now familiar — and driving the width of a continent east. The Southwest, Texas, and finally New York in January: cold, alive, and completely itself.",
    tags: ["Road Trip", "Cities", "Culture"],
    highlights: ["Joshua Tree", "New Orleans", "Grand Canyon", "New York City", "San Diego Revisited"],
    bestTime: "Year-round (varies by region)",
    currency: "USD $",
    story: `I first came to San Diego in 2013 as a 20-year-old student experiencing America for the first time. Returning in 2026, the city felt both familiar and newly strange — I could read it now, understand its geography and rhythms, but also see how much it had changed and how much I had.\n\nThe drive east was the structure. I'd never done a proper American road trip, and the scale of the Southwest demanded it. Joshua Tree at dawn, the joshua trees silhouetted against a pinking sky, absolute silence except for wind. The Grand Canyon, which photographs cannot prepare you for — the brain simply refuses to process the depth correctly until you're standing at the rim and the canyon corrects you.\n\nNew Orleans for the food and the music and the very specific relationship the city has with its own history. Then north and east, the landscape changing from bayou to Appalachian to dense northeastern corridor, until the skyline of New York appeared over the horizon in January grey.\n\nNew York in January is the real New York — stripped of summer tourist comfort, operating at full cold-weather efficiency, every New Yorker moving with the purposeful velocity of someone who has somewhere better to be. I was there for a week and barely scratched it. Manhattan alone is a subject that requires years.`
  },
  {
    id: "south-america-2026",
    title: "South America & Miami",
    countries: ["Chile", "Argentina", "USA"],
    flag: "🇨🇱",
